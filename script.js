...
// var currentHour = document.getElementById("hourNine");
// currentHour.style.backgroundColor = "green";
// $("#currentDay").text = moment().day(Number | String);
...
//use empty stings to show that these variables are where local storage stores input
var tenText = "";
var elevenText = "";
var twelveText = "";
var oneText = "";
